...
export default function OptionsFormSidebar({ loading }: Props) {
    ...
    const menus = [
        {
            ...
            label: __('General Information', 'optionsbot'),
        },
        {
            slug: 'job-description-info',
            label: __('Options Description', 'optionsbot'),
        },
        {
            slug: 'job-company-info',
            label: __('Company Information', 'optionsbot'),
        },
    ];
