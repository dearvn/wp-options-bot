...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    ...
    >
      <RichText
        className="wp-block-options-bot-header_title"
        tagName="h2"
        placeholder={__("Header title", "optionsbot")}
        value={title}
      ...
      <RichText
        className="wp-block-options-bot-header_title"
        tagName="div"
        placeholder={__("Header description", "optionsbot")}
        value={description}
      ...
      />
        ...
        <InspectorControls>
            <PanelBody
                title={__('Color Settings', 'optionsbot')}
                initialOpen={true}
            >
                <ColorPicker
                    color={bgColor}
            ...
            <PanelBody
                title={__('Padding/Margin Settings', 'optionsbot')}
                initialOpen={false}
            >
                <BoxControl
                    label={__('Inline Padding', 'optionsbot')}
                    values={padding}
